...
async def senior_checkin_history(senior_id: int, session: Session = Depends(get_session)):
...
async def senior_missing_checkin_history(senior_id: int, session: Session = Depends(get_session)):
